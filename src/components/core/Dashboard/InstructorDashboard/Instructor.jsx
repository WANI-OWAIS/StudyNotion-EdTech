...
export default function Instructor() {
  ...
  const [instructorData, setInstructorData] = useState([]); // ✅ array by default
  const [courses, setCourses] = useState([]); // ✅ array by default
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const coursesResult = await fetchInstructorCourses(token);
